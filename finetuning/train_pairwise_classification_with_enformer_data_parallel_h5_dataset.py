...
import torch
from datasets import EnformerDataset, PairwiseClassifcationH5Dataset
...
def main():
    ...
    pairwise_train_ds = PairwiseClassifcationH5Dataset(
        args.train_data_path,
        n_pairs_per_gene=args.train_n_pairs_per_gene,
        seqlen=args.seqlen,
    )
    pairwise_val_ds = PairwiseClassifcationH5Dataset(
        args.val_data_path,
